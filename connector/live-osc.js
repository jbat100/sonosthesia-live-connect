...
class OSCToWSSPacker {
    ...
    _setupPackers() {
        ...
        // generated by Ableton live Pressure 
        this._packers['/mpe/aftertouch'] = (args) => {
        ...
        // generated by Ableton live Slide 
        this._packers['/mpe/control'] = (args) => {
            if (!args || args.length < 4) return null;
            return {
                port : "",
                channel : args[0]?.value,
        ...
        // generated by Ableton live Note PB 
        this._packers['/mpe/bend'] = (args) => {
            if (!args || args.length < 3) return null;
            return {
                port : "",
                channel : args[0]?.value,
